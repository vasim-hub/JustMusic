 ...
 * @param albumsRepository Required to pass specific use case's repository [AlbumsRepository]
 */
class GetAlbumsListUserCase @Inject constructor(
    ...
    suspend fun execute(
        ...
        return albumsRepository.fetchAlbumsListing(isRequiredToRefreshData, count)
    }
}